...
Here, I will embedd image from local assets which goes into `assets` directory in project's `root` directory. Choose a specific image, related to particular post. I chose to name the image `Toph_bending_mercury.png`, which I will embedd as:

```markdown
![my alternate text](/assets/images/Toph_bending_mercury.png);
``` 
